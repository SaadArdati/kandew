...
const PRESET_ICONS = ['https://picsum.photos/seed/alpha/80/80', 'https://picsum.photos/seed/beta/80/80', 'https://picsum.photos/seed/gamma/80/80', 'https://picsum.photos/seed/delta/80/80', 'https://picsum.photos/seed/epsilon/80/80', 'https://picsum.photos/seed/zeta/80/80',];
...
export default function TeamCreation() {
    ...
    return (<div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4 py-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2">
                            {PRESET_ICONS.map(url => (<button
                                ...
                                className={`rounded-full overflow-hidden ring-2 transition-all ${!useCustom && selectedIcon === url ? 'ring-primary scale-110' : 'ring-transparent hover:ring-outline'}`}
                            >
                                <img src={url} alt="preset icon" className="w-10 h-10 object-cover"/>
                            </button>))}
                        </div>
