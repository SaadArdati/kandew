...
export default function Landing() {
    return (<div className="landing min-h-dvh flex flex-col text-on-surface">
        ...
        <nav
            ...
            <div className="flex items-center gap-2">
                <Link to="/login"
                      className="text-sm font-medium text-on-surface-variant no-underline px-3 py-2 rounded-lg transition-colors hover:text-primary active:opacity-80">Log
                    in</Link>
                <Link to="/register"
                      className="text-sm font-semibold text-white bg-primary px-5 py-2 rounded-xl no-underline transition-opacity hover:opacity-90 active:opacity-80 max-sm:text-[0.8125rem] max-sm:px-4 max-sm:py-1.75">Sign
                    up</Link>
            </div>
        </nav>
        ...
        <div className="overflow-hidden">
            <section
                className="landing-hero grid grid-cols-2 items-end max-w-6xl w-full mx-auto px-8 pt-20 pb-0 max-md:grid-cols-1 max-md:px-6 max-md:pt-16 max-md:pb-12 max-md:relative max-sm:px-4 max-sm:pt-12 max-sm:pb-10 max-sm:text-center">
                ...
                <div className="flex justify-end items-end max-md:hidden">
                    <img src={rosesImg} alt="Pink roses" className="block w-full max-w-md h-auto object-contain"
        ...
        <section className="py-18 px-8 bg-surface-container max-md:py-14 max-md:px-6 max-sm:py-10 max-sm:px-4">
            <div
                className="max-w-5xl mx-auto grid grid-cols-[1fr_1.5fr] gap-16 items-start max-md:grid-cols-1 max-md:gap-6">
                <h2 className="landing-features-heading text-[1.75rem] font-normal tracking-tight leading-snug">Built
                    for focus</h2>
        ...
        <section className="py-18 pb-12 px-8 max-md:py-14 max-md:px-6 max-sm:py-10 max-sm:px-4">
            <div className="max-w-5xl mx-auto grid grid-cols-2 gap-12 items-center max-md:grid-cols-1 max-md:gap-8">
                <div className="max-sm:text-center">
                        <span
                            className="landing-petals-badge inline-block text-xs font-semibold uppercase tracking-wide text-secondary px-3 py-1 rounded-full">Petal System</span>
                    <h2 className="landing-petals-title text-[1.75rem] font-normal tracking-tight leading-snug mt-4">Reward
                        work, not just track it</h2>
                    ...
                    <ul className="landing-petals-list mt-5 list-none p-0 flex flex-col gap-2 max-md:inline-flex max-md:mx-auto max-md:mt-5 max-sm:text-left">
                        <li className="text-sm text-on-surface-variant">Team managers configure petal value in USD
                        </li>
                        <li className="text-sm text-on-surface-variant">Members earn petals when tasks move to
                            done
                        </li>
                        <li className="text-sm text-on-surface-variant">Earnings tracked per person, visible to
                            everyone
                        </li>
                    </ul>
                </div>
                <div className="flex justify-center">
                    <div
                        className="w-full max-w-72 bg-surface-container border border-outline/80 rounded-2xl p-6 flex flex-col gap-3">
        ...
        <footer className="mt-auto border-t border-outline/80 bg-surface-container">
            <div
                className="flex items-center justify-between px-8 py-6 max-w-6xl w-full mx-auto max-sm:px-4 max-sm:py-5">
                <span className="text-sm font-bold text-primary">Kandew</span>
                <div className="flex items-center gap-6 max-sm:gap-4">
                    <Link to="/login"
                          className="text-[0.8125rem] text-on-surface-variant no-underline transition-colors hover:text-primary">Log
                        in</Link>
                    <Link to="/register"
                          className="text-[0.8125rem] text-on-surface-variant no-underline transition-colors hover:text-primary">Sign
                        up</Link>
                </div>
