...
function hoursAgo(h) {
  return new Date(Date.now() - h * 3600000).toISOString().slice(0, 16)
}
...
export const initialTasks = [
  ...
  // To Do
  {
    ...
    description: 'Simplify the 5-step signup to 3 steps with progress bar.',
    priority: 'high',
    columnId: 'todo',
    teamId: 'team-1',
  ...
  },
  {
    ...
    description: 'Let users download their task history as a spreadsheet.',
    priority: 'medium',
    columnId: 'todo',
    teamId: 'team-1',
  ...
  },
  {
    ...
    description: 'Show recent actions like task moves and comments in a timeline.',
    priority: 'low',
    columnId: 'todo',
    teamId: 'team-1',
  ...
  // In Progress
  {
    ...
    description: 'Upload images and documents to task cards.',
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'Notify users on mobile when assigned a task or mentioned.',
    priority: 'high',
    columnId: 'in-progress',
    teamId: 'team-1',
  ...
  // In Review
  {
    ...
    description: 'Forgot password email with secure token and expiry.',
    priority: 'high',
    columnId: 'review',
    teamId: 'team-1',
    assigneeUserId: 'user-2',
  ...
  // Done
  {
    ...
    description: 'Send branded invite emails when adding new team members.',
    priority: 'high',
    columnId: 'done',
    teamId: 'team-1',
    assigneeUserId: 'user-8',
    ...
    dueDate: hoursAgo(168),
    reviewEnteredAt: hoursAgo(192),
    frozenPetalsAtReview: 4,
    completedAt: hoursAgo(180),
    earnedPetals: 4,
  },
  {
    id: 'task-14',
    title: 'Two-factor authentication',
    description: 'Add TOTP-based 2FA for account security.',
    priority: 'medium',
    columnId: 'done',
    teamId: 'team-1',
    assigneeUserId: 'user-1',
    ...
    dueDate: hoursAgo(144),
    reviewEnteredAt: hoursAgo(168),
    frozenPetalsAtReview: 3,
    completedAt: hoursAgo(156),
    earnedPetals: 3,
  },
  ...
  {
    id: 'task-7',
    title: 'Hero section A/B test',
    description: 'Create two hero variants and set up split testing.',
    priority: 'high',
    columnId: 'todo',
    teamId: 'team-2',
  ...
  {
    id: 'task-15',
    title: 'Contact form with reCAPTCHA',
    description: 'Build contact form with spam protection and email delivery.',
    priority: 'medium',
    columnId: 'todo',
    teamId: 'team-2',
  ...
  // In Progress
  {
    ...
    description: 'Responsive masonry layout with lightbox for project photos.',
    priority: 'high',
    columnId: 'in-progress',
    teamId: 'team-2',
    assigneeUserId: 'user-8',
  ...
  },
  {
    ...
    description: 'Auto-rotating client quotes with manual navigation.',
    priority: 'medium',
    columnId: 'in-progress',
    teamId: 'team-2',
    assigneeUserId: 'user-4',
  ...
  // In Review
  {
    ...
    description: 'Connect headless CMS for client to publish blog posts.',
    priority: 'low',
    columnId: 'review',
    teamId: 'team-2',
    assigneeUserId: 'user-5',
  ...
  {
    id: 'task-3',
    title: 'Site color scheme',
    description: 'Finalize brand palette and apply across all pages.',
    priority: 'low',
    columnId: 'done',
    teamId: 'team-2',
    assigneeUserId: 'user-5',
    ...
    dueDate: hoursAgo(96),
    reviewEnteredAt: hoursAgo(120),
    frozenPetalsAtReview: 2,
    completedAt: hoursAgo(108),
    earnedPetals: 2,
  },
  {
    id: 'task-19',
    title: 'Favicon and social previews',
    description: 'Design favicon, Open Graph images, and Twitter cards.',
    priority: 'low',
    columnId: 'done',
    teamId: 'team-2',
    assigneeUserId: 'user-8',
    ...
    maxPetals: 2,
    createdAt: hoursAgo(200),
    dueDate: hoursAgo(150),
    reviewEnteredAt: hoursAgo(170),
    frozenPetalsAtReview: 2,
    completedAt: hoursAgo(160),
    earnedPetals: 2,
  },
  ...
  // To Do
  {
    ...
    description: 'Full-text search with department and role filters.',
    priority: 'high',
    columnId: 'todo',
    teamId: 'team-3',
  ...
  // In Progress
  {
    ...
    description: 'Submit and approve vacation requests with calendar view.',
    priority: 'high',
    columnId: 'in-progress',
    teamId: 'team-3',
  ...
  },
  {
    ...
    description: 'Calendar-based room reservation with conflict detection.',
    priority: 'medium',
    columnId: 'in-progress',
    teamId: 'team-3',
    assigneeUserId: 'user-8',
  ...
  },
  {
    ...
    description: 'Submit receipts, manager approval, and finance export.',
    priority: 'low',
    columnId: 'in-progress',
    teamId: 'team-3',
    assigneeUserId: 'user-6',
  ...
  // In Review
  {
    ...
    description: 'Single sign-on so employees use their work Google account.',
    priority: 'medium',
    columnId: 'review',
    teamId: 'team-3',
    assigneeUserId: 'user-1',
  ...
  // Done
  {
    ...
    description: 'Admin-posted announcements with read receipts.',
    priority: 'medium',
    columnId: 'done',
    teamId: 'team-3',
    assigneeUserId: 'user-7',
    ...
    maxPetals: 3,
    createdAt: hoursAgo(240),
    dueDate: hoursAgo(192),
    reviewEnteredAt: hoursAgo(216),
    frozenPetalsAtReview: 2,
    completedAt: hoursAgo(204),
    earnedPetals: 2,
  },
  ...
  {
    id: 'task-6',
    title: 'Q3 email campaign brief',
    description: 'Write creative brief with audience segments and goals.',
    priority: 'low',
    columnId: 'todo',
    teamId: 'team-4',
    assigneeUserId: 'user-2',
  ...
  },
  {
    ...
    description: 'Plan and schedule posts for Instagram, LinkedIn, and X.',
    priority: 'high',
    columnId: 'todo',
    teamId: 'team-4',
    assigneeUserId: 'user-8',
  ...
  {
    id: 'task-25',
    title: 'Landing page for webinar',
    description: 'Registration page with countdown timer and speaker bios.',
    priority: 'medium',
    columnId: 'todo',
    teamId: 'team-4',
    assigneeUserId: 'user-2',
  ...
  // In Progress
  {
    ...
    description: 'Campaign performance metrics with charts and export.',
    priority: 'medium',
    columnId: 'in-progress',
    teamId: 'team-4',
    assigneeUserId: 'user-8',
  ...
  // In Review
  {
    ...
    description: 'Drag-and-drop survey creator with response analytics.',
    priority: 'high',
    columnId: 'review',
    teamId: 'team-4',
    assigneeUserId: 'user-2',
  ...
  // Done
  {
    ...
    description: 'Reusable HTML email templates for newsletters and promos.',
    priority: 'medium',
    columnId: 'done',
    teamId: 'team-4',
    assigneeUserId: 'user-8',
    ...
    dueDate: hoursAgo(264),
    reviewEnteredAt: hoursAgo(288),
    frozenPetalsAtReview: 3,
    completedAt: hoursAgo(276),
    earnedPetals: 3,
  },
  {
    id: 'task-28',
    title: 'UTM link generator',
    description: 'Tool to create and track campaign URLs with UTM parameters.',
    priority: 'low',
    columnId: 'done',
    teamId: 'team-4',
    assigneeUserId: 'user-2',
    ...
    dueDate: hoursAgo(240),
    reviewEnteredAt: hoursAgo(264),
    frozenPetalsAtReview: 2,
    completedAt: hoursAgo(252),
    earnedPetals: 2,
  },
]
