...
export default function KanbanBoard({
    ...
    return (<div className="kanban-board-wrapper">
        ...
        {onSearchChange && (<div className="board-filter-bar">
            ...
            {members.length > 0 && (<div className="board-member-filter" role="group" aria-label="Filter by member">
        ...
        <div className="board-column-tabs" role="tablist" aria-label="Columns">
            {tasksByColumn.map((col, i) => (<button
                key={col.id}
                type="button"
                role="tab"
            ...
            {tasksByColumn.map((column, columnIndex) => {
                ...
                >
                    ...
                    <div className="column-body">
                        {column.tasks.length === 0 && !isOver && (isCelebrating ? (
                            <div className="column-celebrate" aria-label="Column cleared">
                                            <span className="column-celebrate-petal"
                            ...
                            </div>) : (<p className="column-empty">
                            <span className="column-empty-icon">🌱</span>
                            Ready to grow
                        </p>))}

                        {column.tasks.map((task, index) => (<div key={task.id}>
                            ...
                            <KanbanCard
                                ...
                                onClick={() => onCardClick({
                                    ...task, columnTitle: column.title, teamName,
                                })}
                    ...
                    {showCreateButton && (<div className="column-create-task-row">
                        <button
                            type="button"
