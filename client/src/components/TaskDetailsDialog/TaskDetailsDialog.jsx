                ...
                <div className="task-dialog-layout">
                    ...
                    <aside className="task-dialog-comments-panel">
                        <div className="task-dialog-comments-header">
                            <h3>Comments</h3>
                            <span className="task-dialog-comment-count">
                        ...
                        <form
                            className="task-dialog-comment-composer"
                        ...
                        <div className="task-dialog-comment-list">
                            {sortedComments.length === 0 ? (
                                <p className="task-dialog-no-comments">
                                    No comments yet.
                                </p>
                            ) : (
                                sortedComments.map((comment) => {
                                    ...
                                    return (
                                        <article
                                            key={comment.id}
                                            className="task-dialog-comment-card"
                                        >
                                            <img
                                                className="task-dialog-comment-avatar"
                                            ...
                                            <div className="task-dialog-comment-body">
                                                <div className="task-dialog-comment-top">
                                                    <div className="task-dialog-comment-meta">
                                                        ...
                                                        {isEdited && (
                                                            <span className="task-dialog-comment-edited">
                                                                edited
                                                            </span>
                                                        )}
                                                    </div>
                                                ...
                                                {isEditing ? (
                                                    ...
                                                    <p className="task-dialog-comment-text">
                                                        {comment.body}
                                                    </p>
                                                )}
                                            </div>
